...
#### Start Script
KMER=21
run_cmd "jellyfish count -C -m $KMER -s $HASHSIZE -o smudgeplot.jellyfish.$KMER.jf -t $NCPUS -F 2 <(zcat ERR571459_trimmed_R1.fastq.gz) <(zcat ERR571459_trimmed_R2.fastq.gz)"
