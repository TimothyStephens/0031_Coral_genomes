...
#### Start Script
KMER=21
run_cmd "jellyfish count -C -m $KMER -s $HASHSIZE -o smudgeplot.jellyfish.$KMER.jf -t $NCPUS -F 14 \
 <(zcat ERR571463_trimmed_R1.fastq.gz) <(zcat ERR571463_trimmed_R2.fastq.gz) \
 <(zcat ERR571462_trimmed_R1.fastq.gz) <(zcat ERR571462_trimmed_R2.fastq.gz) \
 <(zcat ERR571461_trimmed_R1.fastq.gz) <(zcat ERR571461_trimmed_R2.fastq.gz) \
 <(zcat ERR571460_trimmed_R1.fastq.gz) <(zcat ERR571460_trimmed_R2.fastq.gz) \
 <(zcat ERR571459_trimmed_R1.fastq.gz) <(zcat ERR571459_trimmed_R2.fastq.gz) \
 <(zcat ERR571457_trimmed_R1.fastq.gz) <(zcat ERR571457_trimmed_R2.fastq.gz) \
 <(zcat ERR571458_trimmed_R1.fastq.gz) <(zcat ERR571458_trimmed_R2.fastq.gz)"
